...
s = replace_once(s, "from dataclasses import dataclass\n", "from concurrent.futures import ThreadPoolExecutor, as_completed\nfrom dataclasses import dataclass\n", "manager concurrent import")
s = replace_once(s, "from urllib.parse import urlparse\n", "from urllib.parse import unquote, urlparse\n", "manager urllib import")

block = r'''    def _public_mod_details(self, names: list[str]) -> list[dict[str, Any]]:
